...
export const guides2: Guide[] = [
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "소득이 높을수록 인상 폭도 커집니다. 다만 국민연금은 기준소득월액 상한(2026.7~2027.6 기준 659만원)이 있어, 그 이상 소득에서는 국민연금 인상 효과가 제한됩니다. 정확한 내 실수령액은 연봉과 비과세·부양가족을 넣어 계산기로 확인하세요.",
        ],
      },
    ],
    faq: [
  ...
  {
    slug: "same-salary-different-net",
    title: "같은 연봉 4,000만원인데 실수령액이 다른 이유 — 세 가지 변수",
    description:
    ...
    faq: [
      ...
      },
      {
        ...
        a: "총액뿐 아니라 월 지급액 구성, 상여 비중, 비과세 항목, 퇴직금 별도 여부를 확인하세요. 특히 <연봉에 퇴직금 포함>인지 아닌지가 실질 금액을 크게 바꿉니다.",
      },
    ],
    related: ["salary-net-explained", "four-insurance-2026", "bonus-tax"],
  ...
  },
  {
    ...
    related: ["same-salary-different-net", "severance-guide", "health-insurance-after-quit"],
    cta: { href: "/calc/salary", label: "연봉 실수령액 계산해보기" },
  },
];
