...
const faq = [
  ...
  {
    q: "2027년 최저임금은 얼마인가요?",
    a: "2027년 최저시급은 10,700원으로 이미 고시됐습니다(2026년 10,320원에서 380원, 3.7% 인상). 시행일은 2027년 1월 1일이라 2026년 12월까지는 10,320원이 적용됩니다. 월 환산액은 209시간 기준 2,236,300원입니다. 이 계산기는 오늘 날짜에 맞는 최저임금으로 미달 여부를 판정합니다.",
  },
  {
    q: "주휴수당은 누가 받나요?",
...
export default function HourlyPage() {
    ...
    "@graph": [
      ...
      // 검색결과에 "사이트명 > 계산기명" 경로가 표시되도록 한다.
      {
        ...
        itemListElement: [
          ...
          { "@type": "ListItem", position: 2, name: "시급·주휴수당 계산기" },
        ],
      },
    ],
  };
  ...
  return (
    <div>
      ...
      <CalcGuides calcHref="/calc/hourly" />
      <RelatedTools calc="/calc/hourly" />
    </div>
  );
}
